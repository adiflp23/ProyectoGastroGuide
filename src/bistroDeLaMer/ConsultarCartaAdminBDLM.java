 ...
 * @author adiflp
 */
public class ConsultarCartaAdminBDLM extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarCartaAdmin
     */
    public ConsultarCartaAdminBDLM() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarCartaAdminBDLM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarCartaAdminBDLM().setVisible(true);
            }
        });
    }
