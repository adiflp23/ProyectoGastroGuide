 ...
 * @author adiflp
 */
public class LoginBDLM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido a Bistró De La Mer");
    ...
    private void btn_registrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarseActionPerformed
        ...
        RegistrarBDLM re = new RegistrarBDLM();
        re.setVisible(true);
    ...
    private void btn_iniciarsesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_iniciarsesionActionPerformed
        ...
        try {
            ...
            if (tipo == 1) {
                ...
                JOptionPane.showMessageDialog(null, "No Hay Opción Para Clientes Aún.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginBDLM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
