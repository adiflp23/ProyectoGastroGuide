 ...
 * @author adiflp
 */
public class ConsultarHorarioAdminMRA extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarHorarioAdmin
     */
    public ConsultarHorarioAdminMRA() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarHorarioAdminMRA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarHorarioAdminMRA().setVisible(true);
            }
        });
    }
