 ...
 * @author adiflp
 */
public class ConsultarReservasAdminMRA extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarReservasAdmin
     */
    public ConsultarReservasAdminMRA() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarReservasAdminMRA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarReservasAdminMRA().setVisible(true);
            }
        });
    }
