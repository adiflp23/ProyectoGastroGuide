 ...
 * @author adiflp
 */
public class ConsultarCartaAdminTGC extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarCartaAdmin
     */
    public ConsultarCartaAdminTGC() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarCartaAdminTGC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarCartaAdminTGC().setVisible(true);
            }
        });
    }
