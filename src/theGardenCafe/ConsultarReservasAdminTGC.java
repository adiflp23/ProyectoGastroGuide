 ...
 * @author adiflp
 */
public class ConsultarReservasAdminTGC extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarReservasAdmin
     */
    public ConsultarReservasAdminTGC() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarReservasAdminTGC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarReservasAdminTGC().setVisible(true);
            }
        });
    }
